...
HD_PWD='D:/Rick/Computer Engineering/Eletronics and Communication Systems/sorter/vivado/sorter/sorter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sorter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sorter_wrapper.tcl -notrace
