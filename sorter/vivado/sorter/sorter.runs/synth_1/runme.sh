...
HD_PWD='D:/Rick/Computer Engineering/Eletronics and Communication Systems/sorter/vivado/sorter/sorter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sorter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sorter_wrapper.tcl
